        ...
        {product.length > 0
          ? product?.map((value) => (
              <Link
                ...
                className="flex flex-col items-center p-2 mb-5 bg-white border border-gray-200 rounded-lg shadow md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
              >
          ...
          : [0, 1, 2, 3, 4].map((index) => (
              <div
                key={index}
                role="status"
                className="p-3 mb-5 space-y-8 border border-gray-200 rounded-lg shadow animate-pulse md:space-y-0 md:space-x-8 md:flex md:items-center"
              >
